let petSalon = {
  ...
  function init() {
    console.log("init");
    let pet1 = new Pet("Scooby", 4, "Male","Dane", "Grooming", "Dog", "Jim", "555-555-5555");
    let pet2 = new Pet("Bubby",3, "Male", "Poddle", "Nail Cut", "Dog", "Jessie", "158-485-9584");
    let pet3 = new Pet("Fraya", 8, "Female", "tabby","Grooming", "Cat", "Dylan", "123-456-7890");
